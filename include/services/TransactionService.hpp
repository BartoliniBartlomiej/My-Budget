...
public:
    ...
    bool addTransaction(double amount, int categoryId, const std::string& date, const std::string& description, RecurrenceInterval recurrence, const Session& session, const TransactionType type);
